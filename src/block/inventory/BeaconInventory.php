...
/**
 * The beacon's single payment slot. The client renders the power-selection menu; the chosen powers arrive via a beacon
 * payment item-stack-request action, which consumes the item placed here.
 */
